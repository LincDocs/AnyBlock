...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">其他内容</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>同时，这种语法也像代码块一样能够嵌套 (预计V3.3.2版本才支持)</p><div class="language-md line-numbers-mode" data-highlighter="shiki" data-ext="md" data-title="md" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">::::note</span></span>
<span class="line"></span>
...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#E5C07B"}},"-"),s("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}}," 7")])])]),s("div",{class:"line-numbers","aria-hidden":"true",style:{"counter-reset":"line-number 0"}},[s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"})])],-1)])),_:1}),i[7]||(i[7]=d(`<h3 id="container-list" tabindex="-1"><a class="header-anchor" href="#container-list"><span>container = list</span></a></h3><p>container也可以表示为list (但只是一个二层的list)。这意味着关于二层list能做的事，用 container 选择器语法也一样可以做。只是语法上稍有不同：</p><p>例如：标签页</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>\\::: tabs</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>\\:::</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="串联语法、触发其他语法" tabindex="-1"><a class="header-anchor" href="#串联语法、触发其他语法"><span>串联语法、触发其他语法</span></a></h3><p>例如有的插件使用的是代码块选择器，但内容却需要md内容，我们可以优化他：</p><p>例如 tabs标签页、col分栏插件等 (虽然这两其实你应该用anyblock的处理器，也有这两功能)</p><p>例如：引用块转代码块</p>`,10)),i[8]||(i[8]=s("div",{class:"ab-note drop-shadow"},[s("div",{class:"ab-tab-root"},[s("div",{class:"ab-tab-nav"},[s("button",{class:"ab-tab-nav-item",is_activate:"true",onclick:`
          ...
          `},"show"),s("button",{class:"ab-tab-nav-item",is_activate:"false",onclick:`
            const i = 1
            const tab_current = this
            const tab_nav = this.parentNode
            const tab_root = tab_nav.parentNode
            ...
            tab_content_items[i].setAttribute("is_activate", "true")
            tab_content_items[i].setAttribute("style", "display:block")
          `},"withoutPlugin"),s("button",{class:"ab-tab-nav-item",is_activate:"false",onclick:`
            const i = 2
            const tab_current = this
            const tab_nav = this.parentNode
            const tab_root = tab_nav.parentNode
            ...
            tab_content_items[i].setAttribute("is_activate", "true")
            tab_content_items[i].setAttribute("style", "display:block")
          `},"mdSource")]),s("div",{class:"ab-tab-content"},[s("div",{class:"ab-tab-content-item markdown-rendered",style:{display:"block"},is_activate:"true"},[s("div",null,[s("div",{class:"ab-note drop-shadow"},[s("div",{class:"markdown-rendered"},[s("div",null,[s("div",{class:"language-js line-numbers-mode","data-highlighter":"shiki","data-ext":"js","data-title":"js",style:{"--shiki-light":"#383A42","--shiki-dark":"#abb2bf","--shiki-light-bg":"#FAFAFA","--shiki-dark-bg":"#282c34"}},[s("pre",{class:"shiki shiki-themes one-light one-dark-pro vp-code"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#0184BC","--shiki-dark":"#56B6C2"}},">"),s("span",{style:{"--shiki-light":"#A0A1A7","--shiki-light-font-style":"italic","--shiki-dark":"#7F848E","--shiki-dark-font-style":"italic"}}," // 这是一段 **markdown** 文本")]),n(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#0184BC","--shiki-dark":"#56B6C2"}},">"),s("span",{style:{"--shiki-light":"#A626A4","--shiki-dark":"#C678DD"}}," var"),s("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#E06C75"}}," a"),s("span",{style:{"--shiki-light":"#0184BC","--shiki-dark":"#56B6C2"}}," ="),s("span",{style:{"--shiki-light":"#986801","--shiki-dark":"#D19A66"}}," 0"),s("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},"; "),s("span",{style:{"--shiki-light":"#A0A1A7","--shiki-light-font-style":"italic","--shiki-dark":"#7F848E","--shiki-dark-font-style":"italic"}},"// 这是代码")])])]),s("div",{class:"line-numbers","aria-hidden":"true",style:{"counter-reset":"line-number 0"}},[s("div",{class:"line-number"}),s("div",{class:"line-number"})])])])])])])]),s("div",{class:"ab-tab-content-item markdown-rendered",style:{display:"none"},is_activate:"false"},[s("div",null,[s("p",null,"(noPlugin)[X|code(js)]"),s("blockquote",null,[s("p",null,[n("// 这是一段 "),s("strong",null,"markdown"),n(" 文本"),s("br"),n(" var a = 0; // 这是代码")])])])]),s("div",{class:"ab-tab-content-item markdown-rendered",style:{display:"none"},is_activate:"false"},[s("div",null,[s("div",{class:"language-md line-numbers-mode","data-highlighter":"shiki","data-ext":"md","data-title":"md",style:{"--shiki-light":"#383A42","--shiki-dark":"#abb2bf","--shiki-light-bg":"#FAFAFA","--shiki-dark-bg":"#282c34"}},[s("pre",{class:"shiki shiki-themes one-light one-dark-pro vp-code"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#986801","--shiki-dark":"#ABB2BF"}},"["),s("span",{style:{"--shiki-light":"#4078F2","--shiki-dark":"#61AFEF"}},"X|code(js)"),s("span",{style:{"--shiki-light":"#986801","--shiki-dark":"#ABB2BF"}},"]")]),n(`
`),s("span",{class:"line"}),n(`
...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#A0A1A7","--shiki-light-font-style":"italic","--shiki-dark":"#5C6370","--shiki-dark-font-style":"inherit"}},"> var a = 0; // 这是代码")])])]),s("div",{class:"line-numbers","aria-hidden":"true",style:{"counter-reset":"line-number 0"}},[s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"})])])])])])])],-1)),i[9]||(i[9]=s("p",null,[n("例如：代码块转引用块：（这也是在obsidian的callout语法被支持前，"),s("code",null,"Admonition 插件"),n(" 所做的事情）")],-1)),i[10]||(i[10]=s("div",{class:"ab-note drop-shadow"},[s("div",{class:"ab-tab-root"},[s("div",{class:"ab-tab-nav"},[s("button",{class:"ab-tab-nav-item",is_activate:"true",onclick:`
            const i = 0
            const tab_current = this
            const tab_nav = this.parentNode
            const tab_root = tab_nav.parentNode
          ...
          `},"withoutPlugin"),s("button",{class:"ab-tab-nav-item",is_activate:"false",onclick:`
            ...
            tab_content_items[i].setAttribute("is_activate", "true")
            tab_content_items[i].setAttribute("style", "display:block")
          `},"mdSource")]),s("div",{class:"ab-tab-content"},[s("div",{class:"ab-tab-content-item markdown-rendered",style:{display:"block"},is_activate:"true"},[s("div",null,[s("div",{class:"ab-note drop-shadow"},[s("div",{class:"markdown-rendered"},[s("div",null,[s("div",{class:"callout","data-callout":"note"},[s("div",{class:"callout-title"},[s("div",{class:"callout-title-icon"},[s("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round",class:"lucide lucide-pencil"},[s("path",{d:"M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"}),s("path",{d:"m15 5 4 4"})])]),s("div",{class:"callout-title-inner"},"Note")]),s("div",{class:"callout-content"},[s("p"),s("p",null,[n("这是一段 "),s("strong",null,"markdown"),n(" 文本")]),s("p",null,"指令：xCode|addQuote|add(> [!note])"),s("p",null,'指令解释：去除代码块|加入引用块|在第一行插入("> [!note]")')])])])])])])]),s("div",{class:"ab-tab-content-item markdown-rendered",style:{display:"none"},is_activate:"false"},[s("div",null,[s("p",null,"(noPlugin)[xCode|addQuote|add(> [!note])]"),s("div",{class:"language- line-numbers-mode","data-highlighter":"shiki","data-ext":"","data-title":"",style:{"--shiki-light":"#383A42","--shiki-dark":"#abb2bf","--shiki-light-bg":"#FAFAFA","--shiki-dark-bg":"#282c34"}},[s("pre",{class:"shiki shiki-themes one-light one-dark-pro vp-code"},[s("code",null,[s("span",{class:"line"},[s("span",null,"这是一段 **markdown** 文本")]),n(`
`),s("span",{class:"line"},[s("span")]),n(`
`),s("span",{class:"line"},[s("span",null,"指令：xCode|addQuote|add(> [!note])")]),n(`
`),s("span",{class:"line"},[s("span")]),n(`
`),s("span",{class:"line"},[s("span",null,'指令解释：去除代码块|加入引用块|在第一行插入("> [!note]")')])])]),s("div",{class:"line-numbers","aria-hidden":"true",style:{"counter-reset":"line-number 0"}},[s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"})])])])]),s("div",{class:"ab-tab-content-item markdown-rendered",style:{display:"none"},is_activate:"false"},[s("div",null,[s("div",{class:"language-md line-numbers-mode","data-highlighter":"shiki","data-ext":"md","data-title":"md",style:{"--shiki-light":"#383A42","--shiki-dark":"#abb2bf","--shiki-light-bg":"#FAFAFA","--shiki-dark-bg":"#282c34"}},[s("pre",{class:"shiki shiki-themes one-light one-dark-pro vp-code"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},"[xCode|addQuote|add(> "),s("span",{style:{"--shiki-light":"#986801","--shiki-dark":"#ABB2BF"}},"["),s("span",{style:{"--shiki-light":"#4078F2","--shiki-dark":"#61AFEF"}},"!note"),s("span",{style:{"--shiki-light":"#986801","--shiki-dark":"#ABB2BF"}},"]"),s("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},")]")]),n(`
`),s("span",{class:"line"}),n(`
...
`),s("span",{class:"line"}),n(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},"指令：xCode|addQuote|add(> [!note])")]),n(`
`),s("span",{class:"line"}),n(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},'指令解释：去除代码块|加入引用块|在第一行插入("> [!note]")')]),n(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},"```")])])]),s("div",{class:"line-numbers","aria-hidden":"true",style:{"counter-reset":"line-number 0"}},[s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"})])])])])])])],-1)),i[11]||(i[11]=d(`<p>通过这套灵活的处理器语法，假如原插件的语法是X，你能够自己定义一个新语法Y，让Y语法替换X语法的同时让原插件生效！</p><h3 id="别名系统" tabindex="-1"><a class="header-anchor" href="#别名系统"><span>别名系统</span></a></h3><p>当然，你可能嫌弃这样的做法会让指令变得长而不可读，没关系 —— 我们还有别名系统。能够让你用自己定义一个别名来表示一串指令！</p><p>例如插件自带的 <code>code2quote</code> 指令，就是使用了别名系统，本质上，<code>code2quote</code> 完全等同于 <code>xCode|addQuote</code></p><p>插件自带了许多非常自然的别名（特别是<strong>中文</strong>别名），在实际使用中，更推荐你使用这些别名：</p><p>已支持的快捷别名：</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>flow</span></span>
...
<span class="line"><span>卡片</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用别名系统能让该插件的语法入侵性更低，例如：</p>`,8)),i[12]||(i[12]=s("div",{class:"ab-note drop-shadow"},[s("div",{class:"markdown-rendered"},[s("div",null,[s("div",{class:"ab-note drop-shadow"},[s("div",{class:"ab-list-table-parent"},[s("table",{class:"ab-table ab-list-table ab-table-folder"},[s("tbody",null,[s("tr",{class:"ab-foldable-tr",tr_level:"0",is_fold:"false",able_fold:"true",type:"folder"},[s("td",{rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
...
`},[s("td",{rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
          ...
          `},[s("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round",class:"lucide lucide-fold-vertical-icon lucide-fold-vertical"},[s("path",{d:"M12 22v-6"}),s("path",{d:"M12 8V2"}),s("path",{d:"M4 12H2"}),s("path",{d:"M10 12H8"}),s("path",{d:"M16 12h-2"}),s("path",{d:"M22 12h-2"}),s("path",{d:"m15 19-3-3-3 3"}),s("path",{d:"m15 5-3 3-3-3"})])])])])])])],-1)),i[13]||(i[13]=d(`<h2 id="mdit-container的语法冲突问题-选读" tabindex="-1"><a class="header-anchor" href="#mdit-container的语法冲突问题-选读"><span>Mdit-Container的语法冲突问题 (选读)</span></a></h2><h3 id="冲突问题" tabindex="-1"><a class="header-anchor" href="#冲突问题"><span>冲突问题</span></a></h3><p>一开始，anyblock自行设计了一个 “首尾选择器” 语法 (所谓首尾选择器，是指像代码块那样通过头部和尾部标识来选定一个范围)，当时使用的是类似 <code>%{...}%</code> 的语法。后来使用了更为通用的Markdown-it-container语法，即用 <code>:::</code> 来标注头尾。</p><p>而这，会造成一种情况，同时存在下面两种语法：</p><div class="language-md line-numbers-mode" data-highlighter="shiki" data-ext="md" data-title="md" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">:::anyblock处理器名</span></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">内容</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">:::</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在一些情况下，这两种语法之间不会产生冲突。因为他们的第一行所标注的内容不同。但在一些情况下，这两种语法会产生冲突。（该问题不仅可能在有其他mdit插件的环境下可能存在冲突。哪怕在ob中anyblock自己如果去实现扩展一些mdit插件的功能，也可能存在冲突）</p><p>例如：</p><ul><li>anyblock处理器和mdit插件都有 <code>tabs</code>，两者虽然逻辑语法一致，但是是由不同插件实现的</li><li>quote冲突 <ul><li>旧版本：anyblock普通处理器和mdit alert都有 <code>quote</code>，并且在anyblock中的 <code>:::quote</code>，实际上会被别名系统转义为callout的quote，即 <code>add([!quote])|quote</code>，逻辑上与普通处理器中的 <code>[quote]</code> 不同（在最新版本中建议使用 <code>addQuote</code> 代替 <code>quote</code> 处理器）</li><li>新版本：V3.3.0 破坏性更新，将普通处理器的 <code>quote</code> 修改为 <code>addQuote</code>，解决了这一问题</li></ul></li></ul><h3 id="原则与解决方案-旧版做法-弃用-仅参考" tabindex="-1"><a class="header-anchor" href="#原则与解决方案-旧版做法-弃用-仅参考"><span>原则与解决方案 (旧版做法，弃用，仅参考)</span></a></h3><p>综上所述，我们定义了一些原则和技巧来解决这种语法冲突：</p><ul><li><p>设计原则<br> 在定义anyblock处理器名时，应尽可能避开与常用mdit插件冲突的字段。<br> 但这往往是不可避免的，只需留意。<br> 特别是anyblock允许自定义别名，命名冲突也可能是用户行为所导致的。当然，反过来用户也可以用自定义别名来避开命名冲突。</p></li><li><p>强制选用策略<br> 如果只想使用anyblock版本的，很简单，不安装/启用其他mdit插件就行。<br> 如果不想使用anyblock版本的 <code>:::</code> 部分。将对应入口文件 <code>index_mdit.ts</code> 中的 <code>md.use(abSelector_container...)</code> 注释掉即可 (TODO 后续可做成开关选项)</p></li><li><p>优先级策略<br> 不可避免冲突的情况下，应根据插件加载顺序来判断优先选用。这样可以让用户觉得哪个优先。一般建议mdit插件拥有更高的优先级。<br> (未完善和详细测试该行为)</p></li><li><p>局部指定使用版本的方法：<br> 你可以在命令名前加上 <code>||</code>，来强制使用anyblock版本，如 <code>||quote</code>。<br> 这并不是什么特殊规定的特殊语法，原理上只是给前面串联加了个空处理器。这样一来，anyblock会跳过无效/空的处理器，依然能识别和解析。而其他mdit插件则不能。<br> 至于动态指定使用mdit插件的版本，则暂无办法。</p></li></ul>`,11))])}const g=c(v,[["render",k]]),A=JSON.parse('{"path":"/docs/zh/03.%20%E9%80%89%E6%8B%A9%E5%99%A8.html","title":"Selector (选择器)","lang":"zh-CN","frontmatter":{"description":"Selector (选择器) 很多人看到展示页面眼花缭乱的效果，认为 AnyBlock 提供的大量效果处理和渲染是这个插件的内容。 但这并非 AnyBlock 的精髓所在，AnyBlock 插件，看名字就知道，他的精髓在于任意地选择一段范围，并将这一段范围变为 “块” 即 AnyBlock 的精髓在于 —— 选择器 什么是选择器？ 这是插件中的一个重要...","head":[["meta",{"property":"og:url","content":"https://LincDocs.github.io/AnyBlock/docs/zh/03.%20%E9%80%89%E6%8B%A9%E5%99%A8.html"}],["meta",{"property":"og:site_name","content":"AnyBlock"}],["meta",{"property":"og:title","content":"Selector (选择器)"}],["meta",{"property":"og:description","content":"Selector (选择器) 很多人看到展示页面眼花缭乱的效果，认为 AnyBlock 提供的大量效果处理和渲染是这个插件的内容。 但这并非 AnyBlock 的精髓所在，AnyBlock 插件，看名字就知道，他的精髓在于任意地选择一段范围，并将这一段范围变为 “块” 即 AnyBlock 的精髓在于 —— 选择器 什么是选择器？ 这是插件中的一个重要..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Selector (选择器)\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"LincDocs\\",\\"url\\":\\"https://github.com/LincDocs/AnyBlock/\\"}]}"]]},"git":{},"readingTime":{"minutes":11.28,"words":3383},"filePathRelative":"docs/zh/03. 选择器.md","excerpt":"\\n<p>很多人看到展示页面眼花缭乱的效果，认为 AnyBlock 提供的大量效果处理和渲染是这个插件的内容。</p>\\n<p>但这并非 AnyBlock 的精髓所在，<code>AnyBlock</code> 插件，看名字就知道，他的精髓在于任意地选择一段范围，并将这一段范围变为 “块”</p>\\n<p>即 AnyBlock 的精髓在于 —— <strong>选择器</strong></p>\\n<h2>什么是选择器？</h2>\\n<p>这是插件中的一个重要概念，对于 markdwon 的局部解析渲染，有两个重要的步骤</p>\\n<ol>\\n<li>范围识别 (我将完成这一步骤的称为 <code>选择器</code>)</li>\\n<li>将这段范围中的内容进行处理或渲染 (我将完成这一步骤的称为 <code>处理器</code>)</li>\\n</ol>","autoDesc":true,"bioChainData":{"outlink":[],"backlink":[{"title":"README.show","link":"README.show.html"}],"localMap":{"nodes":[{"id":"docs/zh/03. 选择器.md","value":{"title":"03. 选择器","path":"docs/zh/03. 选择器.md","outlink":[],"backlink":["README.show.md"]}},{"id":"README.show.md","value":{"title":"README.show","path":"README.show.md","outlink":[],"backlink":[]}}],"links":[{"source":"README.show.md","target":"docs/zh/03. 选择器.md"}]}}}');export{g as comp,A as data};
