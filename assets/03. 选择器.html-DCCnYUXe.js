...
<span class="line"><span>content2</span></span>
<span class="line"><span></span></span>
<span class="line"><span>\\:::</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h3 id="串联语法、触发其他语法" tabindex="-1">串联语法、触发其他语法</h3><p>例如有的插件使用的是代码块选择器，但内容却需要md内容，我们可以优化他：</p><p>例如 tabs标签页、col分栏插件等 (虽然这两其实你应该用anyblock的处理器，也有这两功能)</p><p>例如：引用块转代码块</p>`,10)),s("div",b,[s("div",null,[r(p,{id:"0",data:[{id:"show"},{id:"withoutPlugin"},{id:"mdSource"}]},{title0:l(({value:e,isActive:a})=>n[6]||(n[6]=[i("show")])),title1:l(({value:e,isActive:a})=>n[7]||(n[7]=[i("withoutPlugin")])),title2:l(({value:e,isActive:a})=>n[8]||(n[8]=[i("mdSource")])),tab0:l(({value:e,isActive:a})=>n[9]||(n[9]=[s("div",{class:"ab-note drop-shadow"},[s("div",{class:"markdown-rendered"},[s("div",null,[s("div",{class:"language-js line-numbers-mode","data-highlighter":"shiki","data-ext":"js",style:{"--shiki-light":"#383A42","--shiki-dark":"#abb2bf","--shiki-light-bg":"#FAFAFA","--shiki-dark-bg":"#282c34"}},[s("pre",{class:"shiki shiki-themes one-light one-dark-pro vp-code"},[s("code",{class:"language-js"},[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#A0A1A7","--shiki-light-font-style":"italic","--shiki-dark":"#7F848E","--shiki-dark-font-style":"italic"}},"// 这是一段 **markdown** 文本")]),i(`
